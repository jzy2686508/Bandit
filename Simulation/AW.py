...
def type1(results,N,T):
    ...
    plt.hist(results, density=True, bins=100, label=type1error)
...
algo = 'greedy'
myparams = {'N': N, 'T': T, 'R': sep_R, 'mean_reward': [0, 0], 'var_reward': [4/3, 4/3],
...
f2.show()
#
# f1.savefig('../Figure/temp/0609_3.pdf')
# f2.savefig("../Figure/temp/0609_4.pdf")
